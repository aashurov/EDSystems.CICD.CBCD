...
public class UserAccountHistoryLookupDtoWithPagination : IMapWith<UserAccountHistory>
{
    ...
    {
        profile.CreateMap<UserAccountHistory, UserAccountHistoryLookupDtoWithPagination>()
