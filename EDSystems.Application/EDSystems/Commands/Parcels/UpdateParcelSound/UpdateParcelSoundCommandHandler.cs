...
public class UpdateParcelSoundCommandHandler : IRequestHandler<UpdateParcelSoundCommand>
{
    private readonly IEDSystemsDbContext _dbContext;
    private IWebHostEnvironment _env;

    public UpdateParcelSoundCommandHandler(IEDSystemsDbContext dbContext, IWebHostEnvironment env) => (_dbContext, _env) = (dbContext, env);

    public async Task<Unit> Handle(UpdateParcelSoundCommand request, CancellationToken cancellationToken)
    {
