...
public class UpdateParcelStatusByIdCommandHandler : IRequestHandler<UpdateParcelStatusByIdCommand>
{
    private readonly IEDSystemsDbContext _dbContext;
    private readonly UserManager<User> _userManager;

    public UpdateParcelStatusByIdCommandHandler(IEDSystemsDbContext dbContext, UserManager<User> userManager) => (_dbContext, _userManager) = (dbContext, userManager);

    public async Task<Unit> Handle(UpdateParcelStatusByIdCommand request, CancellationToken cancellationToken)
    {
